...
case class BloopParametersExtension(project: Project) {
  ...
  private val stdLibName_ : Property[String] =
    project.getObjects.property(classOf[String])
  ...
  @Input @Optional def getIncludeSources: Property[java.lang.Boolean] =
    includeSources_
